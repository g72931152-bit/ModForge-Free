...
async def restart_job(job_id: str):
    ...
    try:
        ...
        jobs[new_id] = {
            ...
            "output_suffix":output_suffix, "output_type":output_type, "restarted_from":job_id,
            "_cancel_event":threading.Event(), "_pause_event":threading.Event()
        }
        persist_job(new_id)
        asyncio.create_task(run_job(new_id, root, original_name, source_kind, source_name, wishes, priority, uploaded_bytes, output_suffix, output_type))
